...
var makevalidTestCases = [...]makevalidCase{
	...
	{ // (4) gdey Circle one, extent not based on tile
		Description: "circle one arbitrary extent",
		MultiPolygon: &geom.MultiPolygon{
			{ // Polygon 
				{ // Ring
	...
	{ // (6) Henry Circle one with slightly modified bbox (6.1388100176202e+06 instead of 6.138810017620263e+06) gives different result...
		Description: "circle one extent modified",
		MultiPolygon: &geom.MultiPolygon{
			{ // Polygon
				{ // Ring
					{1286956.14225588319823146, 6138803.15957210958003998}, 
		...
		ClipBox: geom.NewExtent(
			[2]float64{1.2869314293799447e+06, 6.1388100176202e+06},
			[2]float64{1.286970842222649e+06, 6.138849430462967e+06},
		),
		ExpectedMultiPolygon: &geom.MultiPolygon{
			{ // Polygon
